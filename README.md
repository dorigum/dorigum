...
> 요즘은 직접 만들고, 고치고, 배포하면서 **기획과 개발 사이를 연결하는 힘**을 키우고 있어요 🚀
...
- 🧭 사용자의 불편함을 발견하고, 기능으로 풀어내는 과정을 좋아해요
- 🛠️ 백엔드부터 프론트엔드, 배포까지 직접 부딪히며 배우는 중이에요
- 🔥 매일 조금씩이라도 커밋하면서 꾸준히 성장하는 것이 목표예요
- 📧 `kkamang03@gmail.com`
...
### 💾 Database & Cloud
<img src="https://img.shields.io/badge/MySQL-4479A1?style=for-the-badge&logo=mysql&logoColor=white"> <img src="https://img.shields.io/badge/Oracle-F80000?style=for-the-badge&logo=oracle&logoColor=white"> <img src="https://img.shields.io/badge/Firebase-FFCA28?style=for-the-badge&logo=firebase&logoColor=black">
...
- 📝 먼저 기능의 목적과 사용자 흐름을 정리해요
- 🧩 작은 단위로 구현하고 바로 확인해요
- 🐛 오류가 나면 원인을 기록하면서 해결하려고 해요
- 📚 작업이 끝나면 문서로 남기는 걸 좋아해요
...
> 기획도, 개발도, 사람도 좋아하는 PM형 개발자로 성장하는 중입니다 ✨
