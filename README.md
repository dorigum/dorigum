...
- User Board, Reply, FreeBoard 예제로 게시판 기능 고도화

### Security

- Spring Security 기본 동작 원리 정리
- 로그인 / 회원가입 / 인증 흐름 실습
- JWT 발급, 검증 필터, 사용자 권한 처리
- Swagger 기반 API 문서화 실습
- 예외 처리 구조와 ProblemDetail 정리

### DevOps & Infra

- Git / GitHub 커밋, 브랜치, 원격 저장소 관리
- Docker 이미지, Dockerfile, Docker Compose 실습
- AWS RDS, EC2, 도메인, HTTPS, ALB 개념 정리
- GitHub Actions 기반 CI/CD workflow 작성
- Spring Boot, React, MySQL, Docker 조합의 배포 흐름 학습

### Frontend & Product

- HTML, CSS, JavaScript 기본기
- React, Vite 기반 프론트엔드 구조 이해
- Firebase Authentication / Realtime Database / Hosting 실습
- 사용자 흐름을 고려한 화면 이동, 메모, 체크리스트, 여행지 저장 UX 개선
